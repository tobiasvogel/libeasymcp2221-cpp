...
int main(int argc, char* argv[]) {
    ...
    try {
        ...
        QObject::connect(
            &monitor,
            &libeasymcp2221::qt::GpioMonitor::started,
            [&] {
                button->setText("Stop");
        ...
        QObject::connect(
            &monitor,
            &libeasymcp2221::qt::GpioMonitor::stopped,
            [&] {
        ...
        QObject::connect(
            &monitor,
            &libeasymcp2221::qt::GpioMonitor::risingEdge,
            [&](Pin pin) {
                const auto index = static_cast<std::size_t>(pin);
                risingLabels[index]->setText(
                    QString::number(++risingCounts[index]));
            });

        QObject::connect(
            &monitor,
            &libeasymcp2221::qt::GpioMonitor::fallingEdge,
            [&](Pin pin) {
